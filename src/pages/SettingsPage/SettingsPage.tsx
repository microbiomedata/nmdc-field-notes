...
const steps: Array<StepType> = [
  ...
  {
    selector: "[data-tour='SettingsPage-4']",
    content:
...
const SettingsPage: React.FC = () => {
  ...
  return (
    <IonPage>
      <IonHeader>
        <ThemedToolbar data-tour={"SettingsPage-1"}>
          <IonTitle>Settings</IonTitle>
        </ThemedToolbar>
      </IonHeader>
      <IonContent>
        <span data-tour={"SettingsPage-2"}>
          <SectionHeader>User</SectionHeader>
          <SettingsUserList />
        </span>

        <span data-tour={"SettingsPage-3"}>
          <SectionHeader>Appearance</SectionHeader>
          <SettingsAppearanceList />
        </span>

        <span data-tour={"SettingsPage-4"}>
