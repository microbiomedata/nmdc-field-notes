 ...
 */
export interface StructuredAlias extends Expression, Extensible, Annotatable, CommonMetadata {
 ...
 */
export interface ArrayExpression extends Extensible, Annotatable, CommonMetadata {
 ...
 */
export interface DimensionExpression extends Extensible, Annotatable, CommonMetadata {
    /** the name used for a slot in the context of its owning class.  If present, this is used instead of the actual slot name. */
    alias?: string,
    /** the maximum number of entries for a multivalued slot */
    maximum_cardinality?: number,
 ...
 */
export interface ImportExpression extends Extensible, Annotatable, CommonMetadata {
    import_from: string,
    import_as?: string,
