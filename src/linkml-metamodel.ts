/* This file is /mostly/ autogenerated from the LinkML Metamodel.
 * To regenerate this file from a python project with the `linkml`
 * package installed:
 *
 *   > gen-typescript .venv/lib/python3.9/site-packages/linkml_runtime/linkml_model/model/schema/meta.yaml > linkml-metamodel.ts
 *
 * Since the metamodel does not change too frequently, we don't need
 * to worry about always keeping it updated.
 *
 * When this file was last generated the LinkML TypeScript generator
 * didn't handle the `Anything` class (https://linkml.io/linkml-model/1.7.x/docs/Anything/)
 * particularly well. So the following change was made manually:
 *
